<div>
    <div class=text-center>
        <h1 class="text-3xl text-gray-700 mb-2 uppercase">Catálogo Cooperación</h1>
    </div>
    ...
    <div class="grid justify-center">
        <form action="{{ route('cooperacion.store') }}" class="p-8 shadow-md rounded-md text-left" style="max-width: 400px;" method="POST">
            @csrf
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('cooperacion.edit',$item->id) }}">
