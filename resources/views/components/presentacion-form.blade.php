<div class="grid justify-center">
    <form action="{{ route('presentaciones.store') }}" class="p-8 shadow-md rounded-md text-left" style="max-width: 400px;" method="POST">
        @csrf
        <label class="block mb-2">
            <span class="block text-gray-700 text-sm font-bold mb-2">Nombre de la presentación</span>
